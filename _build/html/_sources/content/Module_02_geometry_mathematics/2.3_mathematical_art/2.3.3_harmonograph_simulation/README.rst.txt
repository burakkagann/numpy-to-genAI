...
Run ``simple_harmonograph.py`` to generate:
...
.. figure:: harmonograph_concept_diagram.png
   ...
   The harmonograph principle: Two independent oscillations (X and Y) combine to create a complex pattern. The damping causes both oscillations to decay over time, which is why the pattern spirals inward.
...
.. figure:: harmonograph_variations.png
   ...
   Effect of frequency ratios on harmonograph patterns. Simple ratios (1:1, 2:1) create simple shapes; complex ratios (5:4, 7:5) create more intricate patterns.
...
Exercise 2: Modify Parameters (4-5 minutes)
-------------------------------------------
...
Exercise 3: Create a Color-Fading Harmonograph (5-6 minutes)
------------------------------------------------------------
