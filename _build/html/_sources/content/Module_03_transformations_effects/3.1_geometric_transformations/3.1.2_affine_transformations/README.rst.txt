...
.. figure:: affine_matrix_diagram.png
   ...
   The 3x3 affine matrix structure. The top-left 2x2 block handles linear transformations (scale, rotate, shear), while the right column handles translation. The bottom row is always [0, 0, 1] for 2D affine transforms.
...
.. figure:: transformation_comparison.png
   ...
   Visual comparison of the four fundamental transformations applied to an arrow shape. Each transformation preserves the straight edges while altering the shape differently.
