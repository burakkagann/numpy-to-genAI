...
:download:`Download simple_rose.py <simple_rose.py>` and run it to generate this output:
...
.. figure:: rose_equation_diagram.png
   ...
   The rose curve in polar coordinates. The radius r varies with angle theta according to the cosine function, creating the characteristic petal shape. Diagram generated with Claude - Opus 4.5.
...
Exercise 3: Create a Colored Rose
----------------------------------
